...
const CreatePost = ({user}) => {
   ...
   */
    ...
    /*selects image with label and displays a preview of the image*/
    ...
    /*remove the image preview and set states to null(the image won't be upload then)*/
    const removePreview = () => {
        if (imageUrl && imagePreview !== null) {
            setImageUrl(null)
        ...
        <div className="new-user-post">
            ...
            <div className='user-content'>
                <form onSubmit={handleSubmit(handleInput)}>
                    ...
                    {/* if an image is selected, then this part will be displayed */}
