...
/* this modal appears when we click on the "modifier" in the comment option modal,
 * it allows users to edit their comment
 * the comment props allows users to update the right comment
